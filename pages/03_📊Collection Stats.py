...
# Sidebar Mint Info
st.sidebar.info("Pirate Life Batch Four: [Mint Now](https://v1.hedgey.finance/#/nfts/)")
...
if selection == "Pixel Pirates":
    ...
    with placeholder.container():
        ...
        dfg = nft_df['address'].value_counts().reset_index()
        dfg['index'].astype(str)
        dfg = dfg.sort_values('address', ascending=False).head(10)
        print(dfg)
